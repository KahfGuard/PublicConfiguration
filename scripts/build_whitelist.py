...
WHITELIST_CATEGORIES: dict[str, list[str]] = {
    "microsoft": [
        ...
        "bing.com", "msedge", "windows", "xbox", "skype", "linkedin", "github",
        "visualstudio", "onedrive", "sharepoint", "teams", "yammer", "hotmail",
        "msft", "msauth", "microsoftonline", "onenote", "sway", "powerbi",
        "powerapps", "flow.microsoft", "defender", "intune", "dynamics",
    ],
    "google": [
        "google", "youtube", "gmail", "gstatic", "googleapis", "ggpht", "ytimg",
        "googlevideo", "gvt1", "gvt2", "gvt3", "doubleclick", "googlesyndication",
        "googleadservices", "googletagmanager", "googleanalytics", "blogger",
        "blogspot", "firebase", "firebaseio", "appspot", "withgoogle", "android",
        "chromium", "ampproject", "recaptcha", "goog", "g.co", "g.page",
    ],
    "apple": [
        "apple", "icloud", "itunes", "mzstatic", "aaplimg", "apple-dns",
    ],
    "meta": [
        "facebook", "fb.com", "fbcdn", "instagram", "whatsapp", "messenger",
        "threads.com", "meta.com", "oculus",
    ],
    "amazon": [
        "amazon.", "amzn", "primevideo", "amazonalexa", "amazontrust", "amazonvideo",
        "ssl-images-amazon", "media-amazon", "a2z.com",
    ],
    "bangladesh": [
        ".bd", "bangladesh", "bangla", "bkash", "nagad", "grameenphone", "robi.com",
        "pathao", "daraz.com.bd", "chaldal", "foodpanda.com.bd", "prothomalo",
        "thedailystar", "bdnews24", "ittefaq", "kalerkantho", "jugantor", "samakal",
        "somewhereinblog", "bikroy", "bdjobs", "shohoz", "rocket.com.bd", "upay",
        "dutchbanglabank", "bracbank", "citybank.com.bd", "ebl.com.bd", "mtb.com.bd",
        "primebank", "standardbankbd", "islamibankbd", "onebankbd", "ucb.com.bd",
        "labaid", "squarehospital", "udvash", "sikho", "muhammadyunus",
    ],
    "infrastructure": [
    ...
    "social-media": [
        "twitter", "x.com", "twimg", "t.co", "tiktok", "snapchat", "reddit",
        "tumblr", "pinterest", "discord", "telegram", "viber", "line.me",
        "vk.com", "vk.ru", "ok.ru", "weibo", "bsky.app",
    ],
    "news-media": [
        "bbc.", "cnn.", "nytimes", "washingtonpost", "reuters", "apnews", "npr.org",
        "theguardian", "forbes", "bloomberg", "wsj.com", "economist", "time.com",
        "newsweek", "huffpost", "buzzfeed", "businessinsider", "techcrunch",
        "wired", "theverge", "cnet", "independent", "telegraph", "dailymail",
        "foxnews", "cbsnews", "nbcnews", "usatoday", "ft.com", "hbr.org",
    ],
    "education": [
        ".edu", "coursera", "udemy", "khanacademy", "edx.org", "duolingo",
        "quizlet", "academia.edu", "researchgate", "arxiv.org", "ieee.org",
        "britannica", "wikipedia", "wikimedia", "cambridge.org",
        "harvard", "mit.edu", "stanford", "berkeley", "cornell", "yale", "princeton",
    ],
    "ecommerce": [
        "ebay", "alibaba", "aliexpress", "shopify", "etsy", "walmart", "target",
        "bestbuy", "costco", "homedepot", "lowes", "ikea", "nike", "shein", "temu",
        "booking.com", "airbnb", "tripadvisor", "agoda", "rakuten",
    ],
    "productivity": [
        "slack", "zoom", "webex", "teamviewer", "anydesk", "notion", "trello",
        "atlassian", "dropbox", "box.com", "adobe", "canva", "figma",
        "mailchimp", "hubspot", "salesforce", "zendesk", "grammarly", "deepl",
        "openai", "chatgpt", "cursor",
    ],
    "gaming": [
        "steam", "epicgames", "playstation", "xbox", "nintendo", "twitch",
        "riot", "blizzard", "ea.com", "ubisoft", "supercell", "unity3d", "kick.com",
    ],
    "security": [
        "kaspersky", "mcafee", "norton", "avast", "sophos", "trendmicro", "eset",
        "paloalto", "checkpoint", "crowdstrike", "sentinelone", "f5.com", "cisco",
    ],
    "government": [
        ".gov", "gov.uk", "gov.br", "europa.eu", "un.org", "who.int",
        "unesco", "worldbank", "whitehouse", "nasa.gov", "nih.gov", "cdc.gov",
    ],
    "finance": [
        "paypal", "stripe", "visa", "mastercard", "bankofamerica",
        "binance", "coinbase", "intuit", "tradingview",
    ],
    "islamic": [
        "quran", "islamqa", "islamicfinder", "sunnah", "alhadith", "muslimcentral",
    ],
    "chinese-tech": [
        "163.com", "360.cn", "360safe", "baidu", "alibaba", "tencent", "qq.com",
        "aliyun", "alicdn", "taobao", "bilibili", "youku", "xiaomi", "huawei",
        "bytedance", "bytedns", "bytefcdn", "douyin", "kwai", "sohu", "sina", "netease",
    ],
    "russian-tech": [
        "yandex", "mail.ru", "rambler", "avito", "sberbank", "gosuslugi",
        "wildberries", "ozon.ru", "pikabu", "dzen.ru", "rutube", "ivi.ru",
        "livejournal", "rbc.ru",
    ],
    "developer": [
        "github", "gitlab", "bitbucket", "stackoverflow", "npm", "pypi",
        "readthedocs", "launchpad", "sourceforge", "gnu.org", "debian", "ubuntu",
        "redhat", "docker", "jsdelivr", "unpkg", "w3.org", "w3schools",
    ],
    "hardware": [
        "asus", "dell", "hp.com", "lenovo", "samsung", "lg.com", "sony",
        "intel", "amd", "nvidia", "cisco", "netgear", "tp-link", "ubnt",
        "mikrotik", "synology", "xerox", "garmin",
    ],
    "streaming": [
        "netflix", "spotify", "disney", "hbo", "hulu", "soundcloud", "bandcamp",
        "vimeo", "dailymotion", "roku", "scdn.co", "spotifycdn", "nflx",
    ],
    "advertising": [
        "adsrvr", "adnxs", "pubmatic", "rubiconproject", "criteo", "taboola",
        "outbrain", "teads", "sharethrough", "openx", "smaato", "inmobi",
        "applovin", "vungle", "adjust", "appsflyer", "branch", "amplitude",
        "mixpanel", "segment", "braze", "onetrust", "cookielaw", "quantcast",
        "newrelic", "datadog", "hotjar", "clarity.ms",
    ],
}
